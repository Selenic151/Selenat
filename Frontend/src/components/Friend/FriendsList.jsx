                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <div className="relative">
                          <div className="w-14 h-14 bg-orange-300 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-md">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-2">
                          <button
                            ...
                            className="px-4 py-2 bg-orange-400 text-white text-sm rounded-lg hover:bg-orange-500 font-medium shadow-sm hover:shadow transition-all duration-200"
                          >
                            Chấp nhận
                          </button>
                          <button
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-orange-400 text-white text-sm rounded-lg hover:bg-orange-500 font-medium shadow-sm hover:shadow transition-all duration-200 flex items-center space-x-2"
                        >
